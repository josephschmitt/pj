...
func defaults() *Config {
	...
	return &Config{
		...
		RawMarkers: MarkerList{
			...
			{Marker: "package.json", Label: "nodejs", DisplayLabel: "NodeJS", Icon: "\U000f0399", HasIcon: true, Color: "green", HasColor: true, Priority: 7, HasPriority: true},
			...
			{Marker: "flake.nix", Label: "nix", DisplayLabel: "Nix", Icon: "\ue843", HasIcon: true, Color: "bright-blue", HasColor: true, Priority: 3, HasPriority: true},
